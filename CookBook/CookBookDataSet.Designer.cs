...
namespace CookBook {
    ...
    public partial class CookBookDataSet : global::System.Data.DataSet {
        ...
        public partial class RecipeDataTable : global::System.Data.TypedTableBase<RecipeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public RecipeRow AddRecipeRow(int Id, string Name, short PrepTime, string Instructions) {
...
namespace CookBook.CookBookDataSetTableAdapters {
    ...
    public partial class RecipeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Recipe] ([Id], [Name], [PrepTime], [Instructions]) VALUES (@Id" +
                ", @Name, @PrepTime, @Instructions);\r\nSELECT Id, Name, PrepTime, Instructions FRO" +
                "M Recipe WHERE (Id = @Id)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Recipe] SET [Id] = @Id, [Name] = @Name, [PrepTime] = @PrepTime, [Instructions] = @Instructions WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([PrepTime] = @Original_PrepTime));
SELECT Id, Name, PrepTime, Instructions FROM Recipe WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Id, string Name, short PrepTime, string Instructions) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((short)(PrepTime));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int Id, string Name, short PrepTime, string Instructions, int Original_Id, string Original_Name, short Original_PrepTime) {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((short)(PrepTime));
            if ((Instructions == null)) {
                throw new global::System.ArgumentNullException("Instructions");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[6].Value = ((short)(Original_PrepTime));
            global::System.Data.ConnectionState previousConnectionState = this.Adapter.UpdateCommand.Connection.State;
            if (((this.Adapter.UpdateCommand.Connection.State & global::System.Data.ConnectionState.Open) 
                        != global::System.Data.ConnectionState.Open)) {
                this.Adapter.UpdateCommand.Connection.Open();
        ...
        public virtual int Update(string Name, short PrepTime, string Instructions, int Original_Id, string Original_Name, short Original_PrepTime) {
            return this.Update(Original_Id, Name, PrepTime, Instructions, Original_Id, Original_Name, Original_PrepTime);
        }
    }
